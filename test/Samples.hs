 ...
 where
  ...
  cvSummary =
    Section
      ...
      (mkResult "93f3bc7f4a0a70716bb2d195b2017c3a")
  cvObjective =
    Section
      (mkResult "77781de7debf1bee3a0dbe5c0a0b4e86")
      (mkResult "701bfec9838456915b1a9e1a10c988a7")
  ...
  cvSpokenLanguages =
    Section
      ...
      [SpokenLanguage (mkResult "8bc3314433e1e51a1404b598b27c3132")]
  cvWorkExperience =
    Section
      ...
      [ WorkExperience
          ...
          , position = "POSITION"
          , employer = "EMPLOYER"
          , workLocation = (mkResult "d99d0adf540c3e458c1b86d04d72ea25")
          , job =
              EmployeeExperience $
                Employee
                  { employerDescription = (mkResult "80a09e88376dd6d50d5acfb60e549c9f")
                  , employerResponsibilities =
                      [ Responsibility
                          { description = (mkResult "00849de1b3b2686900b7ac1622d438a4")
      ...
      , WorkExperience
          ...
          , position = "POSITION 2"
          , employer = "EMPLOYER 2"
          , workLocation = (mkResult "3252f3cbce0573351af1862c7ddc9644")
          , job =
              SelfEmployedExperience
                ( SelfEmployed
                    { customers =
                        [ Customer
                            { customerDescription = (mkResult "4745ce266b7d7d65a9dcaa7e2b3a985f")
                            , customerResponsibilities =
                                [ Responsibility
                                    { description = (mkResult "619620ce744ae1e1ec10a3144ac38e21")
  ...
  pureCacheResult
    { cvPractices =
        (cvPractices pureCacheResult)
          { sectionBody =
              [ SWEPractice $ RunOllamaPrompt defaultChatOps "0b58b1be0c61a0cac440379604e921f2"
              ]
          }
    }
 where
